...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- Skema Warna untuk Guest Layout --}}
        <style>
            body {
            ...
            .guest-image-section.image-1 { background-image: url('{{ asset('images/varian_putihH.jpg') }}'); }
            .guest-image-section.image-2 { background-image: url('{{ asset('images/latar1.jpg') }}'); }
