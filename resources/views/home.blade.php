...
@section('title', 'Selamat Datang di Waiteu Collagen Drink')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-8 flex flex-col md:flex-row items-center p-6 text-center md:text-left" style="background-color: #FDF8F5;">
        <div class="md:w-1/2 p-6">
            ...
            <a href="{{ route('produk.index') }}" class="cta-button bg-blue-600 px-8 py-3 text-xl inline-flex items-center">
                Lihat Produk Kami
        ...
        <div class="md:w-1/2 flex justify-center items-center p-6">
            <img src="{{ asset('images/latar2.jpg') }}" alt="Waiteu Hero Image" class="rounded-lg shadow-xl" style="max-width: 90%; height: auto;">
        </div>
    </div>
    ...
    {{-- Bagian Testimoni Singkat (Opsional, jika ada data testimoni) --}}
    <div class="text-center mb-8">
        ...
        <a href="{{ route('forum') }}" class="cta-button bg-purple-600 mt-6 inline-flex items-center">
    ...
    <div class="text-center bg-brown-50 p-8 rounded-lg shadow-lg border border-gray-200" style="background-color: #E6D2C4; color: #4A4A4A;">
        ...
        <a href="{{ route('keranjang') }}" class="cta-button bg-green-600 px-8 py-3 text-xl inline-flex items-center">
            Pesan Sekarang!
